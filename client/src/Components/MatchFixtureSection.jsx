      ...
      <div className="relative p-4 md:p-5 h-full flex flex-col justify-between">
        ...
        <div className="flex">
          ...
          <div className="flex flex-1 px-4 justify-center items-center">
            <h1 className="text-2xl text-white font-bold">VS</h1>
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-white/10 space-y-2 mt-4">
          <div className="flex items-center gap-2 text-[10px] text-white/50">
            ...
            <span className="font-outfit">
              {isLive ? 'Live' : `Starts at ${match.time}`}
            </span>
          </div>
          <div className="flex items-center gap-2 text-[10px] text-white/50">
            <Users size={12} />
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-2">
            <div>
              ...
              <h2 className="font-anton text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight">
                Upcoming <span className="text-transparent font-bold bg-clip-text bg-gradient-to-r from-red-500 to-red-600">Matches</span>
              </h2>
            </div>
